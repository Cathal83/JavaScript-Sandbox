;(function ( $, window, document, undefined ) {
    ...
    Slidepanel.prototype.init = function () {
        ...
        if($('#slidepanel').length == 0){
            var panel_html = '<div id="slidepanel" class="cb_slide_panel close"><div class="wrapper-main"><a id="panelclose" href="#" class="close">Close</a><div class="inner"><div class="wrapper"></div></div></div></div>';
